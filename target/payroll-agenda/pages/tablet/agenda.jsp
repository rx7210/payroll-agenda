...
<html lang="es">
  <head>
    ...
    $(document).ready(function() {
		...
		$("#left-white-shadow").click(function (){
		...
		$("#right-black-shadow").click(function (){
			$('#right-black-shadow').css('width','0');
	       	$('#r-content').css('right','-450.8px');
		});
		$("#rch-close").click(side_nav ("#right-black-shadow","#r-content"));
				
				
// 				function (){
// 			$('#right-black-shadow').css('width','0');
// 	       	$('#r-content').css('right','-450.8px');s
// 		});
    
    	var rigt_side_nava = new side_nav;
		...
		var side_nav = {
				...
				closeFunction : function(){
					$(this.shadowContent).css('width','0');
		 	       	$(this.content).css(side,'-'+width);
				},
				openFunction : function(){
					$(this.shadowContent).css('width','100%');
		 	       	$(this.content).css(side,'0px');
				}
		}
						...
						<div class="row">
							<div class="col s6">
								<div class="data-write rci-date">
									<div class="input-field">
										<input id="inpNum" type="text" name="" maxlength="10" minlength="10" value="Oct 13, 2017">
										<label for="inpNum">Fecha</label>
							...
							<div class="col s6">
								<div class="data-write rci-hour">
									<div class="input-field">
										<input id="inpNum" type="text" name="" maxlength="10" minlength="10" value="15:35">
										<label for="inpNum">Hora</label>
										<p class="form-tips">Introduce tu ...</p>
									</div>
								</div>
							</div>
